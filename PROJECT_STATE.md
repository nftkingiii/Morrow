...
- A 2:54 prerecorded product explainer was generated from the live Morrow workflows, a truthful privacy-boundary narrative, and verified Mainnet evidence. It uses synthetic narration rather than representing a staged wallet interaction as live. The public video is declared in `strk20.json` at `https://morrow-production.up.railway.app/morrow-demo.mp4`.
